...
#define _PYD_RELEASE_TAG \
    ".cp" Py_STRINGIFY(PY_MAJOR_VERSION) Py_STRINGIFY(PY_MINOR_VERSION)

#if (PY_RELEASE_LEVEL <= PY_RELEASE_LEVEL_BETA)
#define _PYD_COMMON_TAG _PYD_RELEASE_TAG "p"
#else
#define _PYD_COMMON_TAG _PYD_RELEASE_TAG
#endif

#ifdef PYD_PLATFORM_TAG
#define PYD_TAGGED_SUFFIX PYD_DEBUG_SUFFIX _PYD_COMMON_TAG "-" PYD_PLATFORM_TAG ".pyd"
#else
#define PYD_TAGGED_SUFFIX PYD_DEBUG_SUFFIX _PYD_COMMON_TAG ".pyd"
#endif
